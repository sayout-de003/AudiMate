"""
Django management command for encryption key rotation.

Usage:
    python manage.py rotate_encryption_keys [--dry-run] [--force]

This command:
1. Generates a new encryption key
2. Archives the current key for backward compatibility
3. Displays environment variable updates needed
4. Rescans and re-encrypts all tokens with the new key (optional)
"""
